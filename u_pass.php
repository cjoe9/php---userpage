...
$error = array();
    ...
    function check_pass(){
        $error = array();
        global $u_pass, $curr_pass, $new_pass, $con_pass;
        if($curr_pass == NULL || $new_pass == NULL || $con_pass == NULL){
            $error['pass'] = "The password enter area(s) cannot be empty.";
        }
        else if(sha1($curr_pass) != $u_pass){
            $error['pass'] = "Password entered is not correct.";
        }
        else if(sha1($new_pass) == $u_pass){
            $error['pass'] = "The new password cannot be same as the current password.";
        }
...
<div class="b-bar">
    <div class="con">
        <form method="post" action="u_pass.php">
            ...
            <div class="z">
                <p class="b">CURRENT PASSWORD  :</p>
                <input type="password" class="a" name="curr_pass" value=""/>
            </div>
            <div class="z">
            ...
            <div>
                <a href="forg_pass.php" class="f">forget password</a>
            </div>
            <div class="cc">
                <input type="submit" class="sbtn" name="change" value="SAVE"/>
